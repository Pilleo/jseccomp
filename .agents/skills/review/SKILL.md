...
To prevent hyperfocus on low-level mechanics at the expense of developer usage and performance, you must evaluate the project across these seven equal dimensions:
